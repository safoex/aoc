...
if __name__ == "__main__":
    ...
    # workdir = "/home/safoex/Documents/data/aae/release6"
    #
    # assumed_class = 'yellowboxes'
    # testclass = 'cioccolato'
    #
    # panda_dir = "/home/safoex/Documents/data/aae/panda_data_10_02_2021/%s/%s_0/rad_0.35" % (testclass, testclass)
    #
    ...
    #
    # models_dir = '/home/safoex/Documents/data/aae/models/scans/'
    # models_names = ['tiramisu', 'pistacchi', 'cioccolato', 'vaniglia']
    # models = {mname: {'model_path': models_dir + '/' + mname + '.obj', 'camera_dist': None} for mname in models_names}
        ...
        for assumed_class in classes:
            for testclass in classes[assumed_class]:
                if assumed_class != 'babyfood':
                    continue
                panda_dir = "/home/safoex/Documents/data/finals/%s/%d/rad_0.30" % (testclass, n)
                print(panda_dir)
                ...
                results = []
                N = len(nipple.possible_orientations)
                for idx in range(N):
                    ambiguity = 1
                    tabs = ''
                    ...
                    while ambiguity > ambiguity_threshold and j < jump_limit:
                        ...
                        interm_result = result[0], result[1][1] if result[1] is not None else -1
                        interm_results_list.append(interm_result)
                        if result[0] is None:
                            final_class = None
                            break
                        ...
                        if j == jump_limit:
                            final_class = result[0][4]
                    results.append(interm_results_list)
                ...
                #
                #
                with open(panda_dir + '/results.pickle', 'wb') as f:
